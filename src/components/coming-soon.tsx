  ...
  return (
    <main className="flex-1 flex items-center justify-center relative">
      <div className="relative w-full min-h-[calc(100vh-5rem)] flex items-center justify-center overflow-hidden">
        ...
        {/* <div className="absolute inset-0 bg-gradient-to-br dark:from-[#3C096C]/ via-[#5A189A]/70 dark:to-[#9D4EDD]/60 z-0" /> */}
        {/* Background gradient */}
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-4xl rounded-full bg-primary/10 blur-3xl opacity-30" />
        </div>
              ...
              {[...Array(7)].map((_, i) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full transition-all duration-300 cursor-pointer hover:scale-125 ${isActive
